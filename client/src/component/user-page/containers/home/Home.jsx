        ...
        return (
            <div className='home-page'>
                    ...
                    <div className="row service-text">
                        <div className="col-md-5" style={{paddingTop: '100px', fontSize: '18px'}}>
                            <div style={{background: 'rgba(225, 225, 225, 0.9)', padding: '20px'}}>
                                ...
                                <span>- Phục vụ công tác, tour công ty</span><br/>
                                <span>- Cung cấp các dòng xe từ Sedan trở lên</span><br/>
                            </div>
                        </div>
                        <div className="col-md-3 offset-md-4" style={{background: 'rgba(225, 225, 225, 0.9)'}}>
                            <BoxBookCar />
                        </div>
                    </div>
                    {/* <div className="row service-text">
                ...
                <div className='container my-4'>
                    ...
                    <a className='float-right text-danger mt-0'>Xem thêm bảng giá >></a>
